...
function App() {
  ...
  const handleResetWidgetLayout = () => {
    ...
    setDashboardLayoutVersion((prev) => prev + 1);
          ...
          <div
            ...
            <div className="pt-2 border-t border-white/10">
              ...
              <button
                ...
                className="w-full py-2 px-4 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-300/20 text-amber-200 rounded-xl text-sm transition-colors"
              >
                Reset Widget Positions
              </button>
              <p className="mt-2 text-xs text-white/40">
                Todo, Bookmark, Reading, Calendar 내용은 그대로 두고 배치만 기본값으로 되돌립니다.
              </p>
            </div>
